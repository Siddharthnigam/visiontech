...
export const SITE_URL = 'https://visiontech.io'

/** WhatsApp contact — E.164 digits (no +), used to build wa.me links. */
export const WHATSAPP_NUMBER = '919098613462'
export const WHATSAPP_DISPLAY = '+91 90986 13462'
export const WHATSAPP_DEFAULT_MESSAGE =
  "Hi Vision Tech! I'd like to know more about your services."
...
export const SERVICES = [
  {
    ...
    tagline:
      'High-performance websites built to turn traffic into qualified leads.',
    description:
  ...
  },
  {
    ...
    tagline:
      'A full-funnel social presence that turns followers into predictable pipeline.',
    description:
  ...
  },
  {
    ...
    tagline:
      'Complete digital transformation — Web, Social, and Performance Marketing working as one.',
    description:
