...
export const PRICING_TIERS = [
  {
    ...
    description:
      'A custom, launch-ready website designed to turn visitors into customers.',
    features: [
  ...
  },
  {
    ...
    name: 'SEO Services',
    description:
      'Search-first visibility — technical fixes, content, and authority that compound month over month.',
    features: [
      'Technical SEO audit & fixes',
      'Keyword research & content roadmap',
      'On-page optimization (CRO-aligned)',
